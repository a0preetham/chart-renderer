/* @ts-self-types="./chart_renderer_wasm.d.ts" */
...
export class Chart {
    ...
    encode(compression) {
        try {
            ...
            wasm.chart_encode(retptr, this.__wbg_ptr, compression);
     ...
     */
    get height() {
        const ret = wasm.chart_height(this.__wbg_ptr);
        return ret;
    }
    /**
     ...
     */
    get itemCount() {
        const ret = wasm.chart_itemCount(this.__wbg_ptr);
        return ret >>> 0;
    }
    /**
    ...
    constructor(spec) {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            const ptr0 = passStringToWasm0(spec, wasm.__wbindgen_export2, wasm.__wbindgen_export3);
            const len0 = WASM_VECTOR_LEN;
            wasm.chart_new(retptr, ptr0, len0);
            var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
            var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
            var r2 = getDataViewMemory0().getInt32(retptr + 4 * 2, true);
            if (r2) {
     ...
     */
    get plotHeight() {
        const ret = wasm.chart_plotHeight(this.__wbg_ptr);
        return ret;
    }
    /**
     * @returns {number}
     */
    get plotWidth() {
        const ret = wasm.chart_plotWidth(this.__wbg_ptr);
        return ret;
    }
    /**
     ...
     */
    get plotX() {
        const ret = wasm.chart_plotX(this.__wbg_ptr);
        return ret;
    }
    /**
     * @returns {number}
     */
    get plotY() {
        const ret = wasm.chart_plotY(this.__wbg_ptr);
        return ret;
    }
    /**
    ...
    rasterize(scale) {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.chart_rasterize(retptr, this.__wbg_ptr, scale);
            var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
            var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
            if (r1) {
                throw takeObject(r0);
     ...
     */
    get width() {
        const ret = wasm.chart_width(this.__wbg_ptr);
        return ret;
    }
}
 ...
 * @returns {Uint8Array}
 */
export function render_png(spec, compression, scale) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        const ptr0 = passStringToWasm0(spec, wasm.__wbindgen_export2, wasm.__wbindgen_export3);
        const len0 = WASM_VECTOR_LEN;
        wasm.render_png(retptr, ptr0, len0, compression, scale);
        var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
        var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
        var r2 = getDataViewMemory0().getInt32(retptr + 4 * 2, true);
        var r3 = getDataViewMemory0().getInt32(retptr + 4 * 3, true);
...
function __wbg_get_imports() {
    ...
    return {
        __proto__: null,
        "./chart_renderer_wasm_bg.js": import0,
    };
}
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('chart_renderer_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
